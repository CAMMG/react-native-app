...
return subscriptions?subscriptions.map(function(s){return subscription.listener;}):[];
}return listeners;}()
...
var _subscription=subscriptions[i];

// The subscription may have been removed during this event loop.
if(_subscription){
this._currentSubscription=_subscription;
_subscription.listener.apply(
...
if(subscriptions){
for(var i=0,l=subscriptions.length;i<l;i++){
var _subscription2=subscriptions[i];

// The subscription may have been removed during this event loop.
// its listener matches the listener in method parameters
if(_subscription2&&_subscription2.listener===listener){
_subscription2.remove();
}
}
}
