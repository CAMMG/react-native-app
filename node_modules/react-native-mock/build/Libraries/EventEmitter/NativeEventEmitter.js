...
function NativeEventEmitter(nativeModule){_classCallCheck(this,NativeEventEmitter);var _this=_possibleConstructorReturn(this,Object.getPrototypeOf(NativeEventEmitter).call(this,
sharedSubscriber));
...
return _get(Object.getPrototypeOf(NativeEventEmitter.prototype),'addListener',this).call(this,eventType,listener,context);
}return addListener;}()},{key:'removeAllListeners',value:function(){function removeAllListeners(

eventType){
invariant(eventType,'eventType argument is required.');
_get(Object.getPrototypeOf(NativeEventEmitter.prototype),'removeAllListeners',this).call(this,eventType);
}return removeAllListeners;}()},{key:'removeSubscription',value:function(){function removeSubscription(

subscription){
_get(Object.getPrototypeOf(NativeEventEmitter.prototype),'removeSubscription',this).call(this,subscription);
